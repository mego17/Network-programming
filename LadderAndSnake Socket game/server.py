...
window = tk.Tk()
window.title("Snake and Ladder Game player 2")
window.configure(bg="lightblue")  



label_player = tk.Label(window, text="player 2 window")
...
label_player1_position = tk.Label(window, text="Player 1 'blue'  Score (0) : 0")
label_player1_position.grid(row=12, columnspan=10)

label_player2_position = tk.Label(window, text="Player 2 'red'  Score (0) : 0")
